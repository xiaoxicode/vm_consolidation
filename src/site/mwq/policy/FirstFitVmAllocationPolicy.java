...
public class FirstFitVmAllocationPolicy extends VmAllocationPolicy {
	 ...
	 * @post $none
	 */
	public FirstFitVmAllocationPolicy(List<? extends Host> list) {
		super(list);
	...
	public boolean allocateHostForVm(Vm vm) {
		...
		int idIndex = 0; //采用First Fit查找第一个能装下此vm的host
		
		while(!result && idIndex<hosts.size()){
			
			host = hosts.get(idIndex);
